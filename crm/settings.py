...
SECRET_KEY = 'django-insecure-h6@+=6mfvdph=oc$&n#eqk2zl!ql0m7r*d4lry4-3*y+$l*jbp'
...
GRAPHENE = {
    'SCHEMA': 'alx_backend_graphql_crm.schema.schema',  # Assuming your schema is defined in schema.py
}
